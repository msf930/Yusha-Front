...
const formHandler = (event) => {
    ...
    return(
        ...
        <div className="sib-form brevoForm " style={{textAlign: "left", backgroundColor: "none"}}>
                        ...
                        <div style={{padding: "8 0"}}>
                            <div className="sib-form-block" style={{
                                ...
                                <div className="sib-text-form-block"
                                    ...
                                    <h3>Yusha is the AI animation software that allows you to create more with less time needed.
                                    </h3>
                                </div>
                                <div className="sib-text-form-block"
                                     style={{
            ...
            <div className="homeHeaderImgGroup">
                <img src="images/yushaRaisedBubble.png" className="homeHeadImg1" alt=""/>
